...
namespace XpertGroup.CubeSummation.WebSite.App_Code
{
    public class Global : HttpApplication, IContainerAccessor
    {
        ...
        private void InitializeIoC()
        {
            ...
            ioc.Install(new Services.DependencyResolution.Operator.OperatorInstaller());
            ioc.Install(new Services.DependencyResolution.Orchestrator.OrchestratorInstaller());
